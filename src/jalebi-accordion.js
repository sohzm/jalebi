        ...
        this.shadowRoot.innerHTML = `
            <style>
                ...
                * {
                ...
                ::slotted(jalebi-accordion-item:not(:last-child)) {
                    border-bottom: 1px solid var(--border-1, #cccccc);
                }
            </style>
...
class JalebiAccordionItem extends HTMLElement {
    ...
    setupEventListeners() {
        ...
        content.addEventListener('transitionend', e => {
            if (e.propertyName === 'max-height' && this.hasAttribute('expanded')) {
                // Allow content to grow with dynamic content
    ...
    updateExpandedState() {
        ...
        if (isExpanded) {
            ...
            // Set a fixed height before collapsing for animation
    ...
    adjustContentHeight() {
        ...
        // First set height to auto to get the real height
        content.style.maxHeight = 'none';

        // Get the content height
        const contentHeight = content.scrollHeight;

        // Set a fixed height for animation
        content.style.maxHeight = `${contentHeight}px`;
    }
}
